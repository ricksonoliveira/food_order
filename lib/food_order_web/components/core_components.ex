defmodule FoodOrderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodOrderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodOrderWeb.Gettext, "errors", msg, opts)
    end
  end
